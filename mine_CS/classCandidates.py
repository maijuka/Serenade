...
class ExtsBatchDP(ExtsBatch):
    ...
    def setupReservoir(self, constraints):
        self.reservoir_params = {
            ...
            "budget": (constraints.getCstr("dp_budget_ext")*constraints.getCstr("dp_budget"))/(constraints.getCstr("nb_extension_rounds")*2*constraints.getCstr("nb_extensions")*constraints.getCstr("dp_sensitivity")),
